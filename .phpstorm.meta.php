...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\LENOVO\.config\herd\config\valet\Sites\binaryproject\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\LENOVO\\.config\\herd\\config\\valet\\Sites\\binaryproject\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'logout','Mitra.kirim','beranda','report',
'passing','edit','feedback','delete',
'blogs','gerakans.store','gerakans','sendlink','verifytoken','verify.info','reset.pw',
'login','loginpage','register','registerPassing','blogs.store',
'storage.local',);
        registerArgumentsSet('views', 
'auth.login','auth.register','beranda','blog','blogs',
'components.head','components.header','components.layout','components.navbar','emails.emailverify-info',
'emails.reset','emails.verify','faq','gerakan','gerakans',
'mitra','report','tentang','verifyPage','welcome',
...
'MAIL_ENCRYPTION','MAIL_PASSWORD','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','AWS_ACCESS_KEY_ID',
