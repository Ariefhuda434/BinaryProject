                ...
                <div x-show="!isProfil" class="bg-gray-50 rounded-2xl p-6 border border-gray-200 shadow-inner">
                    ...
                    <ul class="space-y-4 text-sm text-gray-700">
                        <li class="flex items-start gap-3">
                            <div class="bg-green-100 text-green-600 px-3 py-1 rounded-full text-xs font-semibold">18 Mei
                                2022</div>
                            <div>
                        ...
                        <li class="flex items-start gap-3">
                            <div class="bg-green-100 text-green-600 px-3 py-1 rounded-full text-xs font-semibold">12 Jan
                                2023</div>
                            <div>
