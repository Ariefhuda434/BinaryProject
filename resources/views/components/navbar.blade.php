  ...
  : 'fixed top-0 left-0 w-full z-50 transition-all duration-500 ease-in-out transform -translate-y-full opacity-0'"
    ...
    <div x-show="isKecil" 
     x-transition
     class="md:hidden bg-gray-300 p-4 w-40 rounded-lg absolute right-0 mr-5 space-y-4">
                <ul class="flex flex-col md:flex-row md:space-x-10 space-y-4 md:space-y-0 text-base content-center">
    <li>
        <a href="/" 
           class="{{ Request::is('/') ? 
                'text-[#ccc14e] font-black pb-3 border-b-4 border-[#ccc14e]' : 
                'relative text-white font-normal pb-2.5 after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-full after:h-[3px] after:bg-[#ccc14e] after:origin-center after:scale-x-0 after:transition-transform after:duration-300 hover:after:scale-x-100' }}">
            Beranda
        </a>
    </li>
    <li>
        <a href="/tentang" 
           class="{{ Request::is('tentang') ? 
                'text-[#ccc14e] font-black pb-3 border-b-4 border-[#ccc14e]' : 
                'relative text-white font-normal pb-2.5 after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-full after:h-[3px] after:bg-[#ccc14e] after:origin-center after:scale-x-0 after:transition-transform after:duration-300 hover:after:scale-x-100' }}">
            Tentang
        </a>
    ...
    <li>
        ...
        <div class="pt-4 border-t">
            ...
            <div x-show="isOpen" x-transition class="mt-2 space-y-2 pl-4">
                @auth   
                <button @click="isProfile = true" id="btnProfil" type="submit" class="block text-gray-700 hover:bg-gray-200">Profile</button>
...
<div class="hidden md:flex md:relative md:p-4 md:items-center md:justify-between w-full">
            ...
            <div class="flex items-center space-x-10  text-3l md:text-2xl font-sans">
             ...
             =      <li>
                ...
                <div class="md:flex space-x-5">
                    ...
                    >
                    @auth
                    <a @click="isProfile = true" id="btnProfil" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200">Profile</a>
   ...
   <section x-data="{isProfil : false,isClose : false}" 
    id="profile"
    class=" flex hidden opacity-0 fixed inset-0 z-50  justify-center items-center py-12 min-h-screen transition-all duration-500 ease-in-out" >
    @auth
