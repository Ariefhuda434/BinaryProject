...
<x-header></x-header>
    <div class="mx-auto mt-20">
        ...
        <div id="visi-misi" class="py-20 bg-gray-200 mt-10 h-screen hidden opacity-0 opacity-100 transition-opacity duration-700 " data-aos="fade-up"">
    ...
    <div class="max-w-8xl mx-auto bg-blue-100 p-10 rounded-lg">
        <p class="text-4xl font-black mb-12 text-center">Meet The Binary Buddies!</p>  

        <!-- Flex container gambar di tengah -->
        <div class="flex justify-center flex-wrap gap-8">
            <img src="{{ asset('build/images/fotoarief.jpg') }}" alt="foto arief" class="rounded-full h-64 border-4 border-white shadow-md">
            <img src="{{ asset('build/images/fotoarief.jpg') }}" alt="foto arief" class="rounded-full h-64 border-4 border-white shadow-md">
            <img src="{{ asset('build/images/fotoarief.jpg') }}" alt="foto arief" class="rounded-full h-64 border-4 border-white shadow-md">
            <img src="{{ asset('build/images/fotoarief.jpg') }}" alt="foto arief" class="rounded-full h-64 border-4 border-white shadow-md">
            <img src="{{ asset('build/images/fotoarief.jpg') }}" alt="foto arief" class="rounded-full h-64 border-4 border-white shadow-md">
