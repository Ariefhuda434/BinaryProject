  ...
  <div class="bg-[#a8b387]">
    <div  class="mt-4 min-w-full">
      <div class=" bg-[#5e6f52] h-30 md:h-60 flex">
        <img src="{{ asset('build/images/test1.jpg') }}" alt="" srcset="" class="md:m-5 m-2 h-26 md:h-50 lg:h-50 lg:w-1/2  md:w-1/3 bg-white object-cover object-bottom">
        <img src="{{ asset('build/images/fotokerjasama.jpg') }}" alt="" srcset="" class="lg:h-full lg:w-[30rem] md:h-60 w-40 md:w-2/3 bg-white">
...
<div class="lg:w-[71rem] md:w-full w-full max-w-6xl mx-auto mt-5 bg-white shadow-xl rounded-xl p-6 lg:p-5 md:p-8 flex flex-col md:flex-row items-center gap-6 md:gap-8" data-aos="fade-up" data-aos-duration="1000">
  ...
  <div class="flex flex-wrap justify-center gap-4">
    <img src="{{ asset('build/images/sdg11.png') }}" alt="SDG 11" class="h-20 w-20 md:h-30 md:w-30 rounded-lg object-cover hover:scale-110 hover:shadow-xl transition duration-300 ease-in-out">
    <img src="{{ asset('build/images/sdg12.png') }}" alt="SDG 12" class="h-20 w-20 md:h-30 md:w-30 rounded-lg object-cover hover:scale-110 hover:shadow-xl transition duration-300 ease-in-out">
    <img src="{{ asset('build/images/sdg13.png') }}" alt="SDG 13" class="h-20 w-20 md:h-30 md:w-30 rounded-lg object-cover hover:scale-110 hover:shadow-xl transition duration-300 ease-in-out">
    <img src="{{ asset('build/images/sdg17.png') }}" alt="SDG 17" class="h-20 w-20 md:h-30 md:w-30 rounded-lg object-cover hover:scale-110 hover:shadow-xl transition duration-300 ease-in-out">
  </div>
...
<p class="text-3xl md:text-4xl lg:text-5xl  text-center  font-bold text-[#5e6f52]" data-aos="fade-up" data-aos-duration="1000">
  ♻️ Sampah itu nggak hilang begitu aja!<br>
  <span class="text-[#3e4936 ] text-2xl">Dukung gerakan ini dengan like, subscribe, dan bagikan ke orang-orang terdekatmu.</span>
</p>
<div class="-mt-28 bg-white px-4 md:px-0 flex  flex-col items-center justify-center shadow-2xl mt-10 rounded-lg w-full md:w-3/4 mx-auto">
