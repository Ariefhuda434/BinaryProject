...
<div class="">
    <div class="relative max-w-4xl mx-auto mt-10 md:mt-20 pt-20 px-4 md:px-8">
        ...
        <p class="max-w-3xl text-center text-gray-600 text-base md:text-xl mb-6 leading-relaxed">
            Laporkan kondisi lingkungan di wilayahmu dengan cepat dan mudah
        </p>
    </div>

    <div class="w-11/12 max-w-6xl mx-auto min-h-[440px] rounded-xl px-2 md:px-0">
        <div class="flex flex-col md:flex-row gap-4 h-full">
            <div class="relative w-full md:w-80 h-64 md:h-full rounded-lg overflow-hidden hover:scale-105 transition-transform duration-300 ease-in-out">
            ...
            <div class="w-full md:w-110 flex flex-col gap-4">
                <div class="flex-1 bg-[#5e6f52] rounded-lg md:-ml-5 p-4 relative flex items-center justify-center hover:scale-105 transition-transform duration-700 ease-in-out">
                    <p class="text-white text-base md:text-2xl font-semibold font-sans leading-snug text-center md:text-start">
                ...
                <div class="flex-1 bg-[#899d7b] rounded-lg p-4 md:-ml-5 hover:scale-105 transition-transform duration-700 ease-in-out">
                    <div class="p-4 md:p-6">
                        <h3 class="text-gray-800 text-lg md:text-xl font-bold mb-2">Apa kamu merasa lebih sadar lingkungan hari ini?</h3>
                        <p class="text-gray-600 text-xs md:text-sm mb-4">Geser untuk beri penilaian jujurmu ya 🌱</p>
                        <form method="POST" action="{{ route('feedback') }}">
                            ...
                            <p id="feelingLabel" class="mt-3 font-semibold text-[#5e6f52] text-sm md:text-base">Cukup sadar ♻️</p>
                        </form>
                    </div>
                </div>
            </div>
            
            <div class="relative w-full md:w-80 h-64 md:h-full rounded-lg shadow-2xl overflow-hidden hover:scale-105 transition-transform duration-700 ease-in-out">
                <img src="{{ asset('build/images/go.png') }}" alt="" class="absolute top-4 right-4 bg-white rounded-full h-9 p-2 rotate-220">
    ...
    <div class="bg-[#a8b387] pb-10 md:pb-20">
        ...
        <div class="md:-mt-130 -mt-20">
            <div class="relative z-10">
                <div class="bg-[#5e6f52] shadow-lg h-16 md:h-20 w-full max-w-md md:max-w-4xl rounded-2xl mx-auto -mb-10 md:-mb-34 mt-10 md:mt-50 flex items-center">
                    <h2 class="text-lg md:text-xl text-white font-semibold ml-6 md:ml-10">Binary Event Project</h2>
                </div>
            </div>
            
            <div class="mt-10 md:mt-20 pt-10 md:pt-20 bg-gray-100 rounded-t-xl pb-10 max-w-6xl mx-auto relative overflow-hidden px-2 md:px-0">
