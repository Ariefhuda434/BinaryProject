...
@section('content')
    <div class="">
        ...
        <div class="w-11/12 max-w-6xl mx-auto min-h-[440px] rounded-xl px-4 lg:px-0">
            <div class="flex flex-col lg:flex-row gap-6 h-full">
                ...
                <div class="w-full lg:w-2/4 flex flex-col gap-4">
                    <div
                        ...
                        <button id="golaporan" class="tranform-all duration-700 ease-in-out">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="absolute bottom-4 right-4 rounded hover:rotate-137 transform-all duration-700 ease-in-out "
                                width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#ffffff"
                    ...
                    <div class="flex-1 bg-[#899d7b] rounded-lg p-4 lg:p-6 ">
                        <h3 class="text-gray-800 text-lg lg:text-xl font-bold mb-2">Apa kamu merasa lebih sadar lingkungan
                            hari ini?</h3>
                        ...
                        <form id="aguslaparnich" method="POST" action="{{ route('feedback') }}">
                            ...
                            <input type="range" min="1" max="5" step="1" value="3"
                                class="w-full accent-[#5e6f52]" name='feedback' onchange="maaci()"
                                oninput="updateFeeling(this.value)">
                            <p id="feelingLabel" class="mt-3 font-semibold text-[#5e6f52] text-sm lg:text-base">Cukup sadar
                                ♻️</p>
                            @if (auth()->guest())
                                <div id="makasiudhbaik"
                                    class="fixed inset-0  hidden opacity-0 flex items-center justify-center z-50 shadow-lg">
                                    <div
                                        class="bg-white text-center rounded-2xl shadow-2xl p-8 max-w-md w-full text-[#5e6f52] relative">

                                        <div
                                            class="w-16 h-16 rounded-full bg-[#5e6f52] text-white flex items-center justify-center mx-auto mb-6 shadow-md">
                                        ...
                                        <h2 class="text-2xl font-extrabold mb-3">Anda Belum Loginn🥲</h2>

                                        <p class="text-gray-700 leading-relaxed mb-6">
                                            Feedback kamu sangat berarti bagi kami.<br>
                                            Tapi login terlebih dahulu yaaa. 🙌
                                        </p>
        ...
        <div id="laporan" class="bg-[#a8b387] pb-20 md:pb-30 -mb-20 lg:-mb-23">
                                                ...
                                                <form action="{{ route('edit', $lapor->id) }}" method="POST">
                                                    ...
                                                    <select name="status" onchange="this.form.submit()"
                                                        ...
                                                        <option value="Menunggu"
                                                            {{ $lapor->status == 'Menunggu' ? 'selected' : '' }}>
                                                            Menunggu
                                                        </option>
                                                        <option value="Diterima"
                                                            {{ $lapor->status == 'Diterima' ? 'selected' : '' }}>
                                                            Diterima
                                                        </option>
                                                        <option value="Diproses"
                                                            {{ $lapor->status == 'Diproses' ? 'selected' : '' }}>
                                                            Diproses
                                                        </option>
                                                    </select>
                                                </form>
                ...
                <button id="btnShow" class="absolute left-4 md:left-10 transform mt-3 md:mt-5">
                    <div class="relative flex items-center space-x-3 group">
                        <div class="relative w-6 h-6 transform transition-transform duration-300 group-hover:rotate-90">
                            <span
                                class="absolute top-1/2 left-0 w-6 h-1 bg-white rounded transform -translate-y-1/2"></span>
                            <span
            ...
            <div id="formlapor"
                class="flex hidden opacity-0 transition-opacity duration-500 ease-in-out items-center justify-center bg-[#a8b387]  pt-10 px-2 md:px-0">
            ...
            <div id="reportbtn"
                ...
                <p class="text-lg md:text-xl font-semibold text-center text-gray-700">Silakan login terlebih dahulu yaa!
                </p>
                <a href="{{ route('login') }}"
